...
INSERT INTO `curso_usuario` VALUES (804,7,1),(804,2,1),(702,3,2),(702,2,2),(702,4,3),(702,2,3),(802,5,4),(802,2,4),(802,6,5),(802,2,5);
...
INSERT INTO `usuario` VALUES (1,'admin','123','Administrador','Ulima',NULL,2,2,NULL,NULL,NULL),(2,'20082219','DFYAPL','Daniel Mauricio','Flores Sánchez','20082219@aloe.ulima.edu.pe',0,0,1,NULL,1),(3,'gromero','gromero','George Edwin','Romero Velazco','gromero@ulima.edu.pe',1,1,1,NULL,1),(4,'cmtorres','cmtorres','Carlos Martín','Torres Paredes','cmtorres@ulima.edu.pe',1,1,1,NULL,1),(5,'jmiranda','jmiranda','Jorge Victor','Miranda Pacheco','jmiranda@ulima.edu.pe',1,1,1,NULL,1),(6,'jfespino','jfespino','José Francisco','Espinoza Matos','jfespino@ulima.edu.pe',1,1,1,NULL,1),(7,'rcheca','rcheca','CHECA FERNANDEZ, ROCIO DEL PILAR','CHECA FERNANDEZ, ROCIO DEL PILAR','rcheca@ulima.edu.pe',1,1,1,NULL,1);
...
INSERT INTO `mensaje_receptor` VALUES (1,7);
...
INSERT INTO `mensaje` VALUES (1,'\"Node.js\"','\"Node.js es un framework creado sobre el motor JavaScript v8 de Google que permite realizar operaciones de entrada y salida de datos de manera no bloqueante y asíncrona, sobre la orientación a objetos está también orientada a eventos, utiliza JavaScript como lenguaje de desarrollo, por lo que a diferencia de otras tecnologías, un mismo lenguaje se usa tanto en back-end y front-end por el cual se facilita el desarrollo del proyecto. De esta plataforma se resalta, antes mencionado, el asincronismo de las operaciones ya que así la respuesta al usuario se hace de manera más rápida, se soporta mayor concurrencia ideal para proyectos en tiempo real. \"',2,NULL,NULL,2,1,NULL,NULL,NULL);
...
-- Dump completed on 2012-08-20 15:25:31
